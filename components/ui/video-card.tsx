  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group flex w-full max-w-[210px] mx-auto flex-col gap-0 rounded-[10px] bg-card shadow-sm overflow-hidden border-0",
          className
        )}
        {...props}
      >
        <div
          className="relative aspect-[235/240] w-full cursor-pointer overflow-hidden"
          onClick={onPlay}
        >
          <Image
            src={imageUrl}
